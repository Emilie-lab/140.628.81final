...
#for the date format, I googled "transform data format in python st.date_input into m/d/yy format like 1/1/20" and followed the steps recommended by AI overview
formatted_selected_date = selected_date.strftime("%#m/%#d/%y") 
...
if datatype == "cumulative": 
    ...
    formatted_previous = previous.strftime("%#m/%#d/%y") 
